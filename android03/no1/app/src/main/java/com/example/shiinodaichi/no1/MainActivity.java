...
package com.example.shiinodaichi.no1;
...
public class MainActivity extends ActionBarActivity {
    ...
    //アダプタークラスです。
    private com.example.shiinodaichi.no1.MessageRecordsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new com.example.shiinodaichi.no1.MessageRecordsAdapter(this);
